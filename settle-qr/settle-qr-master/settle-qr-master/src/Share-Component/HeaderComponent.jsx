                    ...
                    <div className="h-100 overflow-auto  ">
                        ...
                        <div className="userDetails d-none-">
                            <table className="table table-borderless">
                                <tbody>
                                    <tr>
                                        {userInfo !== undefined && userInfo !== null && userInfo.first_name !== '' && userInfo.first_name !== undefined && userInfo.last_name !== '' && userInfo.last_name !== undefined &&
                                            <td>
                                        ...
                                        <td>
                                            {userInfo !== undefined && userInfo !== null && userInfo.first_name !== '' && userInfo.first_name !== undefined && userInfo.last_name !== '' && userInfo.last_name !== undefined &&
                                                <><small className="font-weight-bold">{userInfo.first_name + " "+ userInfo.last_name}</small> <br /></>
                                            }

                                            {userInfo !== undefined && userInfo !== null && userInfo.phone !== '' && userInfo.phone !== undefined && userInfo.phone !== '' && userInfo.phone !== undefined &&
                                                <a className="d-block text-dark font-weight-bold" href="#"><small className="font-weight-bold">{userInfo.phone}</small></a>
                                            }

                                            {userInfo !== undefined && userInfo !== null &&  userInfo.email !== '' && userInfo.email !== undefined && userInfo.email !== '' && userInfo.email !== undefined &&
                                                <><a className="d-inline-block text-dark font-weight-bold" href="#"><small className="font-weight-bold">{userInfo.email}</small></a>
                         ...
                         {auth_token !== '' && auth_token !== undefined && auth_token !== null &&
                            <div className="list-group rounded-0 d-none-">
                                <button className="list-group-item list-group-item-action font-weight-bold" onClick={(e)=>this.logout()}>Sign out</button>
                            </div>
                        }
