                        ...
                        <div className="col-12">
                            <div className="form-group">
                                <div className="d-flex border rounded-8 justify-content-between overflow-hidden">
                                    <input className="border-0 shadow-none   py-2  px-2  h-auto form-control" style={{ fontSize: '10px', width: '150px' }} type="text" placeholder="Credit Card Number " />
                                    ...
                                    <input className="border-0 shadow-none  py-2  px--2 h-auto form-control ml-auto text-center" style={{ fontSize: '10px' }} type="text" placeholder="Postal code" />
                                </div>
                                <small className="form-text text-muted d-none">We'll never share your email with anyone else.</small>
                            </div>
                        </div>
