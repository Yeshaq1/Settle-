...
export default class LoginComponent extends Component {
    ...
    submitForm(e){
        ...
        if(this.validateForm()){
            ...
            axiosInstance.post(`api/userWebApp/login/`,newData)
            .then(res => {
    ...
    render() {
        ...
        return (
            <>
                            ...
                            <div className="row">
                                <div className="col-4 pr-0">
                                    <div className="form-group">
                                        <select className="form-control shadow-none rounded-8 px-1" name="code" onChange={this.onChange.bind(this)} onFocus={this.onFocus.bind(this)} value={formData.code}>
                                ...
                                <div className="col-8">
                                    <div className="form-group">
                                        <input type="text" placeholder="Phone Number" className="form-control shadow-none rounded-8" name="phone" onChange={this.onChange.bind(this)} onFocus={this.onFocus.bind(this)} value={formData.phone} />
                                ...
                                <div className="col-md-12 text-center">
                                    <button className="btn btn-primary btn-sm rounded-8 px-4">Continue</button>
                                </div>
                ...
                {(this.state.isOtpOpen === true) ? <VerifyMobileNumber isLoginVarification={true} mobileno={this.state.formData.code+this.state.formData.phone} emailid={this.state.formData.email} /> : null}
            </>
        )
    }
}
