                ...
                <div className="chooseTops px-3">
                    ...
                    <div className="row flex-nowrap justify-content-between   ">
                        ...
                        <div className="col pl-0">
                            <button className="btn w-100 mb-3 btn-outline-secondary   btn-lg text-dark font-weight-bold rounded-8 " style={{ width: 'auto', fontSize: '1rem' }}>Pay with Visa ***** 4819</button>
                        </div>
                    ...
                    <div className="row flex-nowrap justify-content-between  pb-5 ">
                        <div className="col-auto">
                            <Link to="/thanks" className="btn mb-3 btn-deep-dark btn-lg text-white rounded-8" style={{ width: '100px' }}>
                                <img style={{ height: '18px' }} src={ImagePath.applePay} alt={'Apple Pay'} />
                            </Link>
                        </div>
                        <div className="col pl-0">
                            <Link to="/thanks" className="btn mb-3 btn-outline-secondary  btn-lg text-white rounded-8" style={{ width: '100px' }}>
                                <img style={{ height: '18px' }} src={ImagePath.gPay} alt={'Google Pay'} />
                            </Link>
                        </div>
                    </div>
                </div>
