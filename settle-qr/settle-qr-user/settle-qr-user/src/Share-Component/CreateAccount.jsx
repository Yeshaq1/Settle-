...
export default class CreateAccount extends Component {
  ...
  validateForm() {
    ...
    Object.keys(errors).forEach((field_name) => {
      if (
        field_name !== "card_error" &&
        field_name !== "agree" &&
        (formData[field_name] === undefined || formData[field_name] === "")
      ) {
  ...
  submitForm(e) {
    ...
    if (this.validateForm()) {
      ...
      axiosInstance
        .post(`api/userWebApp/signup/`, registerData)
        .then((res) => {
          if (res.status === 200) {
    ...
    return (
      <>
        {this.state.isOtpOpen === false ? (
          <div>
            <h5 className="text-dark1 text-center font-weight-bold">
              Create your account
            </h5>
            <form noValidate onSubmit={(e) => this.submitForm(e)}>
              <div className="row">
                ...
                <div className="col-4 pr-0">
                  <div className="form-group">
                    <select
                      className="form-control shadow-none px-1 rounded-8"
                      name="code"
                      onChange={this.onChange.bind(this)}
                      onFocus={this.onFocus.bind(this)}
                      value={formData.code}
                ...
                <div className="col-md-12">
                  <p>
                    <small>
                      We will send you a text with a verification code. Message
                ...
                <div className="col-12">
                  <div className="form-group">
                    ...
                    <div className="d-flex border rounded-8 justify-content-between overflow-hidden">
                      ...
                      <DatePicker
                        className={
                          "border-0 shadow-none rounded-0  py-2  px--2 h-auto form-control register-datepicket"
                        }
                        minDate={new Date()}
                        dateFormat={"MM/yyyy"}
                ...
                <div className="col-md-12">
                  <div className="form-group form-check">
                    ...
                    <label className="form-check-label" htmlFor="exampleCheck1">
                      I agree to the Settle Technologies <a href="">Terms</a>{" "}
