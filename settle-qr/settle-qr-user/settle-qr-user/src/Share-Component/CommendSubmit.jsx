...
export default class CommendSubmit extends Component {
        ...
        <div className="d-flex justify-content-between">
          <div>
            <button
              ...
              onClick={() =>
                this.setState({ showModal: false, modalContentType: "1" })
              }
            >
              Close
            </button>
        ...
        <div className="d-flex justify-content-between">
          <div>
            <button
              className="btn btn-sm font-weight-bold text-dark2 p-0"
              onClick={() =>
                this.setState({ showModal: false, modalContentType: "2" })
              }
            >
              Close
            </button>
        ...
        <div className="d-flex justify-content-between">
          <div>
            <button
              className="btn btn-sm font-weight-bold text-dark2 p-0"
              onClick={() =>
                this.setState({ showModal: false, modalContentType: "3" })
              }
            >
              Close
            </button>
  ...
  render() {
    return (
      <>
        <div className="p-3">
          <h6 className="font-weight-bold text-dark1">
            Rate your favorite dishes
          </h6>
          <div className="d-flex justify-content-between">
            <div>
              <button
                style={{ width: "100px", fontSize: "10px", padding: "15px 0" }}
                className="btn rounded-8   btn-primary position-relative"
                onClick={() =>
                  this.setState({ showModal: true, modalContentType: "1" })
                }
              >
                <span className={"d-block"}>Cheeseburger</span>
                <span
                  className={
                    "d-block position-absolute text-center w-100  left-0 bottom-0"
                  }
                >
                  <img src={ImagePath.LittleStar} alt="" /> 5
                </span>
              </button>
            </div>
            <div>
              <button
                style={{ width: "100px", fontSize: "10px", padding: "15px 0" }}
                className="btn rounded-8   btn-primary"
                onClick={() =>
                  this.setState({ showModal: true, modalContentType: "2" })
                }
              >
                Beer
              </button>
            ...
            <div>
              <button
                ...
                className="btn rounded-8   btn-primary"
                onClick={() =>
                  this.setState({ showModal: true, modalContentType: "3" })
                }
              >
                Nachos
              </button>
          ...
          <div className="d-flex align-items-center justify-content-between">
            ...
            <div>
              <a
                href="/home?tableId=5fc78578ed0b4424887c351e"
                className={"btn text-primary font-weight-bold"}
              >
                Submit
              </a>
